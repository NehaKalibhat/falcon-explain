...
def main():
    ...
    resize_transform = torchvision.transforms.Compose([torchvision.transforms.Resize((224, 224))])
    ...
    for feat_str in groups:
        ...
        highly_act_images, highly_act_features, highly_act_cropped_images = falcon_utils.get_clip_image_features(clip_model = clip_model,
        ...
        avg_clip_cos[feat_str] = torch.matmul(highly_act_features, highly_act_features.T).mean().cpu()
